...
const DEFAULT_NOTIFICATIONS: NotificationItem[] = [
  ...
  {
    id: "notif-3",
    title: "Welcome to WalksysDev Panel",
...
export default function NotificationsDropdown() {
  ...
  const [notifications, setNotifications] = useState<NotificationItem[]>(() => {
    try {
      const saved = localStorage.getItem("walksysdev_notifications");
  ...
  useEffect(() => {
    localStorage.setItem("walksysdev_notifications", JSON.stringify(notifications));
  }, [notifications]);
